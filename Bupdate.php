                        ...
                        <table class="table table-bordered table-striped text-center">
                            ...
                            <tbody>
                                ...
                                while ($row = mysqli_fetch_assoc($result)) {
                                    ...
                                    echo "<td><a href='Bedit.php?id=" . urlencode($row['id']) . "' class='btn-edit'>Edit</a></td>";
                                    echo "<td><a href='Bdelete.php?id=" . urlencode($row['id']) . "' class='btn-delete' onclick='return confirm(\"Are you sure you want to delete this record?\");'>Delete</a></td>";
                                    echo "</tr>";
                                }
                                ?>
                            </tbody>
